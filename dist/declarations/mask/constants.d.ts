...
export declare const MASK_CUBOID_PAYLOAD_TEXELS = 6;
/**
 ...
 */
export declare const MASK_FLAG_PRISM = 1;
export declare const MASK_FLAG_EXCLUDE = 2;
/**
 ...
 */
export declare const MASK_COPLANARITY_TOLERANCE = 0.1;
/** Texels a prism of `vertexCount` vertices occupies (two flattened vertices per texel). */
export declare const prismPayloadTexels: (vertexCount: number) => number;
